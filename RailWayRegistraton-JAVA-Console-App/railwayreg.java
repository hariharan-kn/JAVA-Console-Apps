                        ...
                        switch(ach){
                            ...
                            case 4:for(int i=0;i<trains.size();i++){
                                ...
                                for(int j=0;j<trains.get(i).arr.length;j++){
                                    for(int k=0;k<trains.get(i).arr[j].length;k++){
                    ...
                    if(ul!=-1){
                        ...
                        while(!user_exit){
                            ...
                            switch(uc){
                                ...
                                for(int j=0;j<trains.get(ind).arr[0].length;j++){
                                ...
                                if(cb>=0&&cb<users.get(ul).Booked.size()){
                                    ...
                                    for(int i=0;i<users.get(ul).Booked.get(cb).seatno.size();i++){
                                        for(int j=users.get(ul).Booked.get(cb).from;j<users.get(ul).Booked.get(cb).to;i++)
                                        trains.get(tind).arr[j][i]=0;
                                    }
